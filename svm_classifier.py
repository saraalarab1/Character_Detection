...
def test(X_train, Y_train, X_test, Y_test,model_version):
    ...
    try:
        ...
        eval_score, model, X_train, Y_train, X_test, Y_test = train(X_test, Y_test,k_cross_validation_ratio=5, testing_size=0.1, model_version = model_version)
...
def train_svm(features, model_version):
    ...
    eval_accuracy, model, X_train, Y_train, X_test, Y_test = train(x, y, k_cross_validation_ratio=5, testing_size=0.1, model_version = model_version)
