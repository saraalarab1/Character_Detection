...
with open('data_with_colors.json', 'r') as f: 
    ...
    y = []
    for i in data.keys():
        x.append([data[i]['aspect_ratio'],data[i]['horizontal_ratio'],data[i]['vertical_ratio'],data[i]['percentage_of_horizontal_symmetry'],data[i]['percentage_of_vertical_symmetry']])
